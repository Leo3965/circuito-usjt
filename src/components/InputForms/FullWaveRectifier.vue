<template>
  <div class="field">
    ...
    <div class="control">
      <input id="fwr-tf" class="input" type="number" placeholder="Volts">
    </div>
  </div>
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="fwr-n1" class="input" type="number" placeholder="N1">
    </div>
  </div>
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="fwr-n2" class="input" type="number" placeholder="N2">
    </div>
  </div>
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="fwr-f" class="input" type="number" placeholder="Hz">
    </div>
  </div>
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="fwr-r" class="input" type="number" placeholder="Ohms">
    </div>
  </div>
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="fwr-c" class="input" type="number" placeholder="µF">
    </div>
  </div>
...
import FullWaveRectifier from "@/objects/model/FullWaveRectifier";

export default defineComponent({
  name: "FullWaveRectifier",
  emits: ["FullWaveRectifierResult", "clear"],
  data() {
    return {
      FullWaveResult: {} as FullWaveRectifier,
    }
  },
  methods: {
    handleCalc() {
      ...
      this.FullWaveResult = new FullWaveRectifier(
      ...
      const result = this.FullWaveResult.calcRectifier();
      this.$emit('FullWaveRectifierResult', result);
    },
    getInputs() {
      const v = document.querySelector('#fwr-tf') as HTMLInputElement;
